...
class SecurityController {
    getAllSessions(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const sessions = yield session_service_1.default.getAllSessionsBy((_a = req.context.user) === null || _a === void 0 ? void 0 : _a.userId);
    ...
    deleteAllSessionsExceptCurrent(req, res) {
        return __awaiter(this, void 0, void 0, function* () { });
    }
    deleteDeviceSession(req, res) {
        return __awaiter(this, void 0, void 0, function* () { });
    }
}
