...
class BlogsQueryRepository {
    getBlogs(sortingData, blogId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!blogs) {
                throw new blogs_service_1.CustomError(blogs_service_1.BlogErrors.NO_BLOGS);
            }
            return {
    ...
    getBlogById(searchablePostId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!post) {
                throw new blogs_service_1.CustomError(posts_service_1.PostErrors.NO_POST_WITH_SUCH_ID);
            }
            return post;
        });
    }
