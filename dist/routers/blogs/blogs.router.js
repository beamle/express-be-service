...
exports.blogsRouter.get('/:blogId/posts', authorization_middleware_1.authMiddleware, blogs_middlewares_1.blogIdAsParamValidator, validationHelpers_1.inputCheckErrorsFormatter, posts_controller_1.default.getPosts);
...
exports.blogsRouter.delete("/:id", authorization_middleware_1.authMiddleware, posts_middlewares_1.middlewareObjectIdChecker, 
// blogIdInputValidator,
