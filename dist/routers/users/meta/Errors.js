...
exports.UsersErrors = {
    ...
    NO_USER_WITH_SUCH_EMAIL_OR_LOGIN_OR_ID: { message: "User with such email or login or ID was not found!", field: "loginOrEmail", status: 401 },
    NO_USER_WITH_SUCH_LOGIN: { message: "User with such login was not found!", field: "loginOrEmail", status: 401 },
